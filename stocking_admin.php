                        ...
                        <div class="col-md-8">
                            <div class="d-none">
                                <div class="row my-2 mx-0">
                                    ...
                                    <div class="col-md-3">
                                        <h5>
                                            <p class="text-right">Graph Settings: </p>
                                        </h5>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="row px-2">
                                            <div class="col-md-6">
                                                <label style="display: block; text-align:right; " for="graph_low">Low</label>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="graph_low" name="graph_low" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="row px-2">
                                            <div class="col-md-6">
                                                <label style="display: block; text-align:right; " for="graph_medium">Medium</label>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="graph_medium" name="graph_medium" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="row px-2">
                                            <div class="col-md-6">
                                                <label style="display: block; text-align:right; " for="graph_high">High</label>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="graph_high" name="graph_high" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- </div> -->
            ...
            <form id="part_modal_form" method="post">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="level_low">Low</label>
                            <input type="number" class="form-control" autocomplete="off" name="level_low" required>
                        </div>
                        <div class="form-group">
                            <label for="level_medium">Medium</label>
                            <input type="number" class="form-control" autocomplete="off" name="level_medium" required>
                        </div>
                        <div class="form-group">
            ...
            $(document).on('submit', '#part_modal_form', function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        level_low: $('input[name="level_low"]').val(),
                        level_medium: $('input[name="level_medium"]').val()
                    },
                    success: function(result) {
                        console.log(result);
                        if (result == 'Ok')
            ...
            $(document).on('click', '.edit-part', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        form.find('input[name="level_low"]').val(result.level_low);
                        form.find('input[name="level_medium"]').val(result.level_medium);
