          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="cycle_value" name="cycle_value"
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="opr_pick_value" name="opr_pick_value"
                    style="width: 200px; display: inline-block">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="opr_delivery_value" name="opr_delivery_value"
                    style="width: 200px; display: inline-block">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="driver_value" name="driver_value"
                    style="width: 200px; display: inline-block">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="pause_value" name="pause_value"
                    value='<?php echo get_setting("pause_time");?>' style="width: 200px; display: inline-block">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="live_build" name="live_build"
                    style="width: 200px; display: inline-block">
                      ...
                      <tr id="tr_dolly_0">
                        ...
                        <th>
                          <div class="input-group dolly-colorpicker colorpicker-element" id="dolly_color_0">
                            <input type="text" class="form-control" name="dolly_color" id="input_dolly_color_0" value=""
      ...
      <div class="modal-content">
        ...
        ?>
          <div class="modal-body" style="">
            <input type="text" class="form-control" style="width: 50%; margin:10px auto; text-align: center"
              name="daterange" value="<?php echo $aaa; ?> - <?php echo $aaa; ?>" />
            <div class="d-flex" style="justify-content: center">
              <button type="button" class="btn btn-danger m-2" id="clear_all" style="width:150px"
                data-target="#deleteModal" data-toggle="modal" data-dismiss="modal">Clear All</button>
