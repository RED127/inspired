          ...
          <div class="row m-0 p-0 finish-box" id="kanban_area">
            ...
            <div class="col-md-6 text-center">
              <div class="item-div" id="input_div">
                <input type="text" class="form-control kanban_input" id="kanban_input" name="kanban_input" autofocus
                  placeholder="INPUT">
              </div>
            </div>
            <div class="col-md-3 align-items-center" style="display: flex">
              <button class="btn text-center" id="button_dolly"
                style="margin: 0 auto; width: 150px; background-color: #3B23A7; color: #FFF;">Dolly</button>
            </div>
            ...
            <div class="col-md-6">
              <div class="font-2" style="color: #fff; font-size: 10px; background: #3b3b3b; margin-top: 15px;">Pick
                Address:</div>
              <div class="font-5" id="current_address"></div>
              <div class="font-2" style="color: #fff; font-size: 10px; background: #3b3b3b; margin-top: 15px">Delivery
                Address:</div>
            ...
            <div class="col-md-6 p-2">
              <a class="btn action bg-blue" id="btn_finish"
                style="background-color:#00FF51; padding-top: 10px;">Finish</a>
            </div>
  ...
  $(document).ready(function() {
    ...
    */
    ...
    function read_pick_list() {
      ...
      // console.log("AAAAAA: ", cycle, zone, current_kanban_id);
      $.ajax({
        url: "actions.php",
        method: "post",
        data: {
    ...
    function check_finish() {
      ...
      console.log(status,'========',cycle,'========',zone,pick_date);
      $.ajax({
        url: "actions.php",
        method: "post",
        data: {
      ...
      if (e.keyCode == 13) {
        ...
        if (kanban_no != '' || address != '') {
          ...
          if (value == kanban_no || value == address) {
            console.log("AAAAA: ", kanban_id, user, formattedToday)
            // alert("AAA")
            $.ajax({
              url: "actions.php",
              method: "post",
